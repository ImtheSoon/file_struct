...
public class Framework extends Canvas {
     ...
     */
    public static enum GameState{STARTING, VISUALIZING, GAME_CONTENT_LOADING, MAIN_MENU, PAUSE, OPTIONS, PLAYING_MOON, PLAYING_EARTH, PLAYING_SPACE, GAMEOVER, DESTROYED}
    /**
            ...
            switch (gameState)
            {
                ...
                case PLAYING_SPACE:
                   ...
                   if(Canvas.keyboardKeyState(KeyEvent.VK_P)){                		                                                            		                		
                	   ...
                	   pauseLastTime = System.nanoTime();
                   }
                   
                   pauseTime = pauseLastTime - pauseStartTime;
                break;
                case PAUSE:
